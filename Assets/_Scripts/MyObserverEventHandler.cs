...
public class MyObserverEventHandler : MonoBehaviour
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        GameObject Bell = GameObject.Instantiate(BellPrefab);
        Bell.transform.position = this.transform.position;
        Bell.transform.parent = this.transform;
        BellPrefab.SetActive(false);
    }

    protected virtual void OnTrackingLost()
    {
        Destroy(GameObject.Find("Bell(Clone)"));
    }
